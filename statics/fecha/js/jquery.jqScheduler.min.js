...
c){var d=(parseFloat(a.css(b[0],"paddingLeft",!0))||0)+(parseFloat(a.css(b[0],"paddingRight",!0))||0),e;e=(parseFloat(a.css(b[0],"borderLeftWidth",!0))||0)+(parseFloat(a.css(b[0],"borderRightWidth",!0))||0);d+=e;e=c?(parseFloat(a.css(b[0],"marginLeft",!0))||0)+(parseFloat(a.css(b[0],"marginRight",!0))||0):0;return d+e}function Ca(b,c){var d;d=(parseFloat(a.css(b[0],"paddingTop",!0))||0)+(parseFloat(a.css(b[0],"paddingBottom",!0))||0);var e;e=(parseFloat(a.css(b[0],"borderTopWidth",!0))||0)+(parseFloat(a.css(b[0],
"borderBottomWidth",!0))||0);return d+e+(c?gb(b):0)}function gb(b){return(parseFloat(a.css(b[0],"marginTop",!0))||0)+(parseFloat(a.css(b[0],"marginBottom",!0))||0)}function Ka(a,b){b="number"==typeof b?b+"px":b;a.each(function(a,c){c.style.cssText+=";min-height:"+b+";_height:"+b})}function cb(){}function hb(a,b){return a-b}function xa(a){return(10>a?"0":"")+a}function Qa(a,c){if(a[c]!==b)return a[c];for(var d=c.split(/(?=[A-Z])/),e=d.length-1,f;0<=e;e--)if(f=a[d[e].toLowerCase()],f!==b)return f;return a[""]}
function ya(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/'/g,"&#039;").replace(/"/g,"&quot;").replace(/\n/g,"<br />")}function ib(a){return a.id+"/"+a.className+"/"+a.style.cssText.replace(/(^|;)\s*(top|left|width|height)\s*:[^;]*/ig,"")}function Ma(a){a.attr("unselectable","on").css("MozUserSelect","none").bind("selectstart.ui",function(){return!1})}function Na(a){a.children().removeClass("fc-first fc-last").filter(":first-child").addClass("fc-first").end().filter(":last-child").addClass("fc-last")}
...
c,d){function e(b){var c=b||1==N,d=v.start.getMonth(),f=r(new Date),g,h,m;c&&V.each(function(b,c){g=a(c);h=u(b);g.html(F(h,Ha));Sa(g,h)});ga.each(function(b,e){g=a(e);h=u(b);h.getMonth()==d?g.removeClass("fc-other-month"):g.addClass("fc-other-month");+h==+f?g.addClass(fa+"-state-highlight fc-today"):g.removeClass(fa+"-state-highlight fc-today");g.find("div.fc-day-number").text(h.getDate());c&&Sa(g,h)});y.each(function(b,c){m=a(c);b<N?(m.show(),b==N-1?m.addClass("fc-last"):m.removeClass("fc-last")):
...
function l(a){return n(a.row,a.col)}function n(a,b){return h(q(v.visStart),7*a+b*G+R)}function u(a){return n(Math.floor(a/I),a%I)}function w(a){return(a-Math.max(qa,U)+I)%I*G+R}var v=this;v.renderBasic=function(c,d,g,h){N=d;I=g;(Y=D("isRTL"))?(G=-1,R=I-1):(G=1,R=0);qa=D("firstDay");U=D("weekends")?0:1;fa=D("theme")?"ui":"fc";Ha=D("columnFormat");if(d=!J){var m=fa+"-widget-header",q=fa+"-widget-content",k;g="<table class='fc-border-separate' style='width:100%' cellspacing='0'><thead><tr>";for(k=0;k<
I;k++)g+="<th class='fc- "+m+"'/>";g+="</tr></thead><tbody>";for(k=0;k<c;k++){g+="<tr class='fc-week"+k+"'>";for(m=0;m<I;m++)g+="<td class='fc- "+q+" fc-day"+(k*I+m)+"'><div>"+(h?"<div class='fc-day-number'/>":"")+"<div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div></div></td>";g+="</tr>"}c=a(g+"</tbody></table>").appendTo(b);P=c.find("thead");V=P.find("th");J=c.find("tbody");y=J.find("tr");ga=J.find("td");H=ga.filter(":first-child");ja=y.eq(0).find("div.fc-day-content div");
...
c.formatDate,P,V,J,y,ga,H,ja,X,L,K,M,N,I,C,Q,W,Y,G,R,qa,U,fa,Ha;Ma(b.addClass("fc-grid"));C=new Wa(function(b,c){var d,e,f;V.each(function(b,g){d=a(g);e=d.offset().left;b&&(f[1]=e);f=[e];c[b]=f});f[1]=e+d.outerWidth();y.each(function(c,g){c<N&&(d=a(g),e=d.offset().top,c&&(f[1]=e),f=[e],b[c]=f)});f[1]=e+d.outerHeight()});Q=new Xa(C);W=new Ya(function(a){return ja.eq(a)})}function xb(){function b(c){var e=t(),f=x(),g=q(d.visStart),f=h(q(g),f),m=a.map(c,S),k,l,n,u,O,p,r=[];for(k=0;k<e;k++){l=wa(ba(c,
...
b&&(a=mb);mb=a;T={};var d=N.position().top,e=U.position().top,g=Math.min(a-d,sa.height()+e+1);W.height(g-Ca(Q));Y.css("top",d);U.height(g-e-1);Ia=kb.height()+1;c&&f()};t.beforeHide=function(){ob=U.scrollTop()};t.afterShow=function(){U.scrollTop(ob)};t.defaultEventEnd=function(a){var b=q(a.start);return a.allDay?b:m(b,x("defaultEventMinutes"))};t.timePosition=v;t.dayOfWeekCol=D;t.dateCell=function(a){return{row:Math.floor(s(a,t.visStart)/7),col:D(a.getDay())}};t.cellDate=da;t.cellIsAllDay=p;t.allDayRow=
...
b,c)};Ta.call(t,c,d,e);Ua.call(t);Va.call(t);yb.call(t);var x=t.opt,F=t.trigger,P=t.clearEvents,V=t.renderOverlay,J=t.clearOverlays,y=t.reportSelection,ga=t.unselect,pa=t.daySelectionMousedown,ja=t.slotSegHtml,X=d.formatDate,L,K,M,N,I,C,Q,W,Y,G,R,qa,U,fa,Ha,sa,kb,ra,za,na,lb,mb,ta,Oa,bb,Ia,ob,ha,ab,va,Aa,Pa,T={},Ja,ea,wa,la,aa,ba,ua,ka,Fa;Ma(c.addClass("fc-agenda"));va=new Wa(function(b,c){var d,e,f;M.each(function(b,g){d=a(g);e=d.offset().left;b&&(f[1]=e);f=[e];c[b]=f});f[1]=e+d.outerWidth();x("allDaySlot")&&
(d=qa,e=d.offset().top,b[0]=[e,e+d.outerHeight()]);for(var g=fa.offset().top,h=U.offset().top,m=h+U.outerHeight(),k=0;k<ab;k++)b.push([Math.max(h,Math.min(m,g+Ia*k)),Math.max(h,Math.min(m,g+Ia*(k+1)))])});Aa=new Xa(va);Pa=new Ya(function(a){return C.eq(a)})}function yb(){function c(b){b=wa(ba(b,a.map(b,S),n.visStart,n.visEnd));var d,e=b.length,f,g,h,m=[];for(d=0;d<e;d++)for(f=b[d],g=0;g<f.length;g++)h=f[g],h.row=0,h.level=d,m.push(h);return m}function d(a){return a.end?q(a.end):m(q(a.start),u("defaultEventMinutes"))}
function e(a,b){var c="<",d=a.url,f=jb(a,u),g=f?" style='"+f+"'":"",h=["fc-event","fc-event-skin","fc-event-vert"];p(a)&&h.push("fc-event-draggable");b.isStart&&h.push("fc-corner-top");b.isEnd&&h.push("fc-corner-bottom");h=h.concat(a.className);a.source&&(h=h.concat(a.source.className||[]));c=d?c+("a href='"+ya(a.url)+"'"):c+"div";c+=" class='"+h.join(" ")+"' style='position:absolute;z-index:8;top:"+b.top+"px;left:"+b.left+"px;"+f+"'><div class='fc-event-inner fc-event-skin'"+g+"><div class='fc-event-head fc-event-skin'"+
g+"><div class='fc-event-time'>"+ya(U(a.start,a.end,u("timeFormat")))+"</div></div><div class='fc-event-content'><div class='fc-event-title'>"+ya(a.title)+"</div></div><div class='fc-event-bg'></div></div>";b.isEnd&&s(a)&&(c+="<div class='ui-resizable-handle ui-resizable-s'>=</div>");return c+("</"+(d?"a":"div")+">")}function f(a,b,c){var d=b.find("div.fc-event-time");p(a)&&k(a,b,d);c.isEnd&&s(a)&&l(a,b,d);B(a,b)}function g(a,b,c){function d(){m||(b.width(e).height("").draggable("option","grid",null),
...
buttonIcons:{prev:"circle-triangle-e",next:"circle-triangle-w"}},ea=a.fullCalendar={version:"1.5.1"},la=ea.views={};a.fn.fullCalendar=function(d){if("string"==typeof d){var e=Array.prototype.slice.call(arguments,1),f;this.each(function(){var c=a.data(this,"fullCalendar");c&&a.isFunction(c[d])&&(c=c[d].apply(c,e),f===b&&(f=c),"destroy"==d&&a.removeData(this,"fullCalendar"))});return f!==b?f:this}var g=d.eventSources||[];delete d.eventSources;d.events&&(g.push(d.events),delete d.events);d=a.extend(!0,
{},ka,d.isRTL||d.isRTL===b&&ka.isRTL?Ab:{},d);this.each(function(b,e){var f=a(e),h=new c(f,d,g);f.data("fullCalendar",h);h.render()});return this};ea.sourceNormalizers=[];ea.sourceFetchers=[];var qb={dataType:"json",cache:!1},rb=1;ea.addDays=h;ea.cloneDate=q;ea.parseDate=w;ea.parseISO8601=B;ea.parseTime=A;ea.formatDate=H;ea.formatDates=T;var ub="sun mon tue wed thu fri sat".split(" "),eb=864E5,sb=36E5,zb=6E4,tb={s:function(a){return a.getSeconds()},ss:function(a){return xa(a.getSeconds())},m:function(a){return a.getMinutes()},
...
var h=a("<tr></tr>");a(g).append(h);var k=a("<th colspan='5' align='left'></th>");h.append(k);var l=a("<select class='opsel'></select>");k.append(l);var h="",B;for(f=0;f<e.groupOps.length;f++)B=b.groupOp===d.p.groupOps[f]?" selected='selected'":"",h+="<option value='"+d.p.groupOps[f]+"'"+B+">"+d.p.groupOps[f]+"</option>";l.append(h).bind("change",function(){b.groupOp=a(l).val();d.onchange()});h="<span></span>";this.p.groupButton&&(h=a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>"),
h.bind("click",function(){void 0===b.groups&&(b.groups=[]);b.groups.push({groupOp:e.groupOps[0],rules:[],groups:[]});d.reDraw();d.onchange();return!1}));k.append(h);var h=a("<input type='button' value='+' title='Add rule' class='add-rule ui-add'/>"),A;h.bind("click",function(){void 0===b.rules&&(b.rules=[]);for(f=0;f<d.p.columns.length;f++){var a="undefined"===typeof d.p.columns[f].search?!0:d.p.columns[f].search,c=!0===d.p.columns[f].hidden;if(!0===d.p.columns[f].searchoptions.searchhidden&&a||a&&
!c){A=d.p.columns[f];break}}b.rules.push({field:A.name,op:(A.searchoptions.sopt?A.searchoptions.sopt:d.p.sopt?d.p.sopt:"string"===A.searchtype?d.p.stropts:d.p.numopts)[0],data:""});d.reDraw();return!1});k.append(h);null!==c&&(h=a("<input type='button' value='-' title='Delete group' class='delete-group'/>"),k.append(h),h.bind("click",function(){for(f=0;f<c.groups.length;f++)if(c.groups[f]===b){c.groups.splice(f,1);break}d.reDraw();d.onchange();return!1}));if(void 0!==b.groups)for(f=0;f<b.groups.length;f++)k=
a("<tr></tr>"),g.append(k),h=a("<td class='first'></td>"),k.append(h),h=a("<td colspan='4'></td>"),h.append(this.createTableForGroup(b.groups[f],b)),k.append(h);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0]);if(void 0!==b.rules)for(f=0;f<b.rules.length;f++)g.append(this.createTableRowForRule(b.rules[f],b));return g};this.createTableRowForRule=function(b,c){var d=this,f=a("<tr></tr>"),g,k,l,w,B="",A;f.append("<td class='first'></td>");var H=a("<td class='columns'></td>");f.append(H);var T=a("<select></select>"),
...
e).val(),""==a.trim(b.title)?alert("Title is required"):(b.description=a("#description",e).val(),b.location=a("#location",e).val(),b.className=a("#categories",e).val(),b.access=a("#access",e).val(),b.user_id=a("#user_id",e).val(),g={},g.event_id=b.id,g.start=b.start.getTime()/1E3,g.end=b.end.getTime()/1E3,g.title=b.title,g.description=b.description,g.location=b.location,g.categories=a("#categories",e).val(),g.access=b.access,g.user_id=b.user_id,g.all_day=b.allDay?1:0,g.oper="editEvent",a.ajax({url:a.jqschedule.calendarurl,
...
e).val(b.location);a("#categories",e).val(b.className);a("#access",e).val(b.access);a("#start",e).val(a.fullCalendar.formatDate(b.start,a.jqschedule.locales.dateFormat));a("#starttime",e).val(a.fullCalendar.formatDate(b.start,"HH:mm"));a("#end",e).val(a.fullCalendar.formatDate(b.end?b.end:b.start,a.jqschedule.locales.dateFormat));a("#endtime").val(a.fullCalendar.formatDate(b.end?b.end:b.start,"HH:mm"));a("#user_id",e).val(b.user_id);d={};d[a.jqschedule.locales.bClose]=function(){e.dialog("close")};
...
f).val(),""==a.trim(h.title)?alert("Title is required"):(h.description=a("#description",f).val(),h.location=a("#location",f).val(),h.className=a("#categories",f).val(),h.access=a("#access",f).val(),h.user_id=a("#user_id",f).val(),k={},k.start=h.start.getTime()/1E3,k.end=h.end.getTime()/1E3,k.title=h.title,k.description=h.description,k.location=h.location,k.categories=a("#categories",f).val(),k.access=h.access,k.user_id=h.user_id,k.all_day=h.allDay?1:0,k.oper="newEvent",a.ajax({url:a.jqschedule.calendarurl,
data:k,dataType:"json",type:"POST",success:function(b,c){b.event_id&&(h.id=b.event_id,h._id=b.event_id,a(a.jqschedule.calendarid).fullCalendar("renderEvent",h,!1),f.dialog("close"))}})))};b[a.jqschedule.locales.bCancel]=function(){f.dialog("close")};f.dialog({modal:!0,width:490,position:{at:"center bottom",of:a.jqschedule.calendarid},closeOnEscape:!1,title:a.jqschedule.locales.addCaption,close:function(){f.dialog("destroy");f.hide();f=null},buttons:b}).show();a(".ui-dialog").css({"font-size":"12px",
"z-index":1000004})},eventLoading:function(b){if(b){b=a(".calwrapper").width();var d=a(".calwrapper").height()+10;a("body").append('<div class="ui-widget-overlay" style="width:'+b+"px;height:"+d+'px;z-index: 1001;"></div>');a("#progresspar").show()}else a(".ui-widget-overlay").remove(),a("#progresspar").hide()},eventDrop:function(b,d,c,e,f){null==b.end&&(b.end=b.start);a.ajax({url:a.jqschedule.calendarurl,data:{oper:"moveEvent",event_id:b.id,start:b.start.getTime()/1E3,end:b.end.getTime()/1E3,all_day:e?
1:0},type:"post"})},eventResize:function(b,d,c,e,f,g,k){null==b.end&&(b.end=b.start);a.ajax({url:a.jqschedule.calendarurl,data:{oper:"resizeEvent",event_id:b.id,start:b.start.getTime()/1E3,end:b.end.getTime()/1E3},type:"post"})},eventRender:function(a,d,c){try{a.description&&d.tooltip({position:{my:"left bottom",at:"center top",offset:"-30 -10",of:d},content:function(c){return a.description}})}catch(e){}},changeCalendarUser:function(){var b=a("#caluser");b.dialog({modal:!0,width:400,title:a.jqschedule.locales.userCaption,
close:function(){b.dialog("destroy");b.hide();b=null},buttons:[{text:a.jqschedule.locales.bChange,click:function(){var d=a("#switchuser",this).val();a.ajax({url:a.jqschedule.calendarurl,data:{_user_id:d,oper:"switchUser"},type:"post",success:function(b,d){a(a.jqschedule.calendarid).fullCalendar("refetchEvents");a("#common_search").val("");a(".fnd-results").html("");a("#search_table").empty();var f=a("#switchuser option:selected");if(1>=f.length)a("#cal_user").html("<li>"+f.text()+"</li>");else{var g=
"";a.each(f,function(){g+="<li>"+a(this).text()+"</li>"});a("#cal_user").html(g)}}});b.dialog("close")}},{text:a.jqschedule.locales.bCancel,click:function(){b.dialog("close")}}]}).show();a(".ui-dialog, .ui-dialog-buttonpane").css({"font-size":"12px","z-index":1000004});return!1},printEvents:function(){if(a("#b_search_cal").hasClass("ui-state-active")){var b=a("#common_search").val(),d="simple";if(""==b){var d="complex",c=a("#search_cal");if(c){c=c.jqFilter("filterData");if(!c.rules.length)return!1;
try{b=xmlJsonClass.toJson(c,"","",!1)}catch(e){try{b=JSON.stringify(c)}catch(f){}}}}window.location=a.jqschedule.calendarurl+"?oper=printEvents&stype="+d+"&search=true&svalue="+b}else d=jQuery(a.jqschedule.calendarid).fullCalendar("getView"),b=d.start.getTime()/1E3,d=d.end.getTime()/1E3,window.location=a.jqschedule.calendarurl+"?oper=printEvents&start="+b+"&end="+d;return!1},exportEvents:function(){if(a("#b_search_cal").hasClass("ui-state-active")){var b=a("#common_search").val(),d="simple";if(""==
b){var d="complex",c=a("#search_cal");if(c){c=c.jqFilter("filterData");if(!c.rules.length)return!1;try{b=xmlJsonClass.toJson(c,"","",!1)}catch(e){try{b=JSON.stringify(c)}catch(f){}}}}window.location=a.jqschedule.calendarurl+"?oper=exportEvents&stype="+d+"&search=true&svalue="+b}else d=jQuery(a.jqschedule.calendarid).fullCalendar("getView"),b=d.start.getTime()/1E3,d=d.end.getTime()/1E3,window.location=a.jqschedule.calendarurl+"?oper=exportEvents&start="+b+"&end="+d;return!1},showSearch:function(){a("#common_search").val()&&
(a("#common_search").val(""),a("#b_common_search").trigger("click"));a(this).addClass("ui-state-active");a(".fc-view-agendaWeek, .fc-view-agendaDay, .fc-view-basicDay, .fc-view-basickWeek, .fc-view-month, .fc-view-year").hide();a(".fc-view-search").show();a("#common_search").focus()},hideSearch:function(){a(this).removeClass("ui-state-active");var b=a(a.jqschedule.calendarid).fullCalendar("getView").name;a(".fc-view-search").hide();a(".fc-view-"+b).show()},_filSearchTable:function(b,d){a(d).empty();
